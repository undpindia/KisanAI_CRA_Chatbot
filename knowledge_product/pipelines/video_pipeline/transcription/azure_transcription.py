...
#     sound.export("data3/converted/"+file_name+".wav", format="wav")
...
#     speech_recognizer = speechsdk.SpeechRecognizer(speech_config=speech_config, audio_config=audio_input, language="bn-IN")
...
#         transcriptions = transcribe_audio(speech_config, "data3/converted/"+file_name+".wav")
#         print(transcriptions)
#         transcriptions_to_srt(transcriptions, "data3/srt/"+file_name+".srt")


# # speech_config = speechsdk.SpeechConfig(subscription="<key>", region="centralindia")
# # run_on_dir(speech_config, "data3/original")
